import test from'node:test';import assert from'node:assert/strict';import{questions}from'../assets/data/questions.js';import{shuffle,selectQuestions,validateQuestions,nextHighScore,formatBestScore}from'../assets/js/quiz-engine.js';
