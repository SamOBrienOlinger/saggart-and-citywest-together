...
export const learningSections = [
  { id: 'place', title: 'Place and identity', intro: 'Meet two connected communities at the meeting point of historic village, growing neighbourhood and Dublin Mountains landscape.', items: [
    ...
    { title: 'Citywest and Fortunestown', scope: 'Growing neighbourhood', body: 'Citywest and Fortunestown form a newer residential and employment district east of Saggart. Planning for the area connects housing growth with public transport, services and public spaces.', source: 'neighbourhood' },
  ...
  { id: 'people', title: 'People and population', intro: 'Census figures tell us about people living in an area at a particular time. Check the area covered before comparing numbers.', items: [
    { title: 'A young local population', scope: 'Saggart Built Up Area', body: 'Census 2022 counted 4,573 people in the Saggart Built Up Area. Its average age was 30.4 years, making Saggart the youngest Irish town in the 1,500 to 10,000 population category. The area counted by the CSO does not exactly match the full Saggart and Citywest community.', source: 'csoPopulation' },
    { title: 'Age groups', scope: 'Saggart Built Up Area', body: 'Of the 4,573 people counted, 1,529 were aged under 15 (33.4%), 377 were 15–24 (8.2%), 1,594 were 25–44 (34.9%), 795 were 45–64 (17.4%) and 278 were 65 or older (6.1%). Percentages are calculated from the CSO’s five-year age groups and rounded to one decimal place.', source: 'csoAge' },
    ...
    { title: 'Explore your neighbourhood', scope: 'Small Area data', body: 'Citywest is not separately named in the CSO town table used for this snapshot. The Census interactive map lets you explore published data at neighbourhood and Small Area level without counting the same area twice.', source: 'csoMap' }
  ] },
  { id: 'heritage', title: 'History and heritage', intro: 'Explore Saggart and Citywest through photographs, village stories and places that are still part of everyday life.', items: [
  ...
  { id: 'connections', title: 'Growth and connections', intro: 'Roads, public transport, jobs and new homes connect the old village with the growing neighbourhood around it.', items: [
    ...
    { title: 'Homes, jobs and services', scope: 'Planning', body: 'Citywest Business Campus and nearby employment areas play an important economic role. A growing area also needs community centres, shops, schools and public spaces that everyone can use.', source: 'neighbourhood' },
    { title: 'A connected village', scope: 'Saggart', body: 'County planning describes Saggart as closely connected to growing Citywest and Fortunestown while supporting new development that improves the village centre and supports walking and cycling.', source: 'growth' }
  ] },
  { id: 'nature', title: 'Nature and landscape', intro: 'The hills, valleys, hedgerows and parks provide homes for wildlife and places for people to enjoy.', items: [
    ...
    { title: 'Slade Valley and green links', scope: 'Plants and wildlife', body: 'Council planning identifies Slade of Saggart and Crooksling Glen for their natural heritage value and explains how hedgerows connect wildlife habitats and form part of local history.', source: 'neighbourhood' }
  ] },
  { id: 'community', title: 'Community and belonging', intro: 'People feel more at home when they share local spaces, can use services and have a say in the area’s future.', items: [
    { title: 'Community spaces', scope: 'Local services', body: 'Parks, playgrounds and community centres help turn new development into sustainable neighbourhoods. Council planning identifies facilities such as Carrigmore Green, Citywest playground and Saggart Community Centre.', source: 'neighbourhood' },
    { title: 'Making it easier for everyone to join in', scope: 'Community development', body: 'Everyone should be able to use local services and have a say in decisions, whatever their age or background, including people from minority ethnic communities.', source: 'community' },
    { title: 'Responding to racism', scope: 'Anti-racism', body: 'Racism can happen between people, in organisations and through wider rules and practices. INAR provides guidance for people who experience or witness racism, including how to seek support, report incidents and take action as a community.', source: 'reportRacism' },
    { title: 'Read the original sources', scope: 'Continue learning', body: 'Use the Council’s village, planning, heritage and walking resources together with Logainm.ie and INAR’s anti-racism resources to explore local history, equality and community participation.', source: 'inar' }
  ] },
  { id: 'health', title: 'Health services', intro: '<strong>Call 112 or 999 for a life-threatening emergency.</strong> Contact services directly to check appointments, who can use the service, opening hours and whether a GP practice is accepting new patients.', items: [
